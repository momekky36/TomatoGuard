...
evaluate.py
-----------
Loads the best checkpoint and reports test-set performance:
...
def main():
    ...
    _, _, test_loader, _ = build_dataloaders(args.data_dir)
    ...
    ax.set_title("Confusion Matrix - Tomato Leaf Disease Test Set")
